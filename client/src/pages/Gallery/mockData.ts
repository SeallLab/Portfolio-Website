...
export const mockGalleryImages: GalleryImage[] = [
  {
    ...
    description:
      "Installing solar panels at our research facility to study energy efficiency and output optimization.",
    image: {
      fields: {
        title: "Solar Panel Installation",
  ...
  },
  {
    ...
    description:
      "Annual team workshop where we discuss new research directions and collaborate on innovative solutions.",
    image: {
      fields: {
        title: "Team Workshop",
  ...
  },
  {
    ...
    description:
      "Collecting data from wind turbines to analyze performance metrics and environmental impact.",
    image: {
      fields: {
        title: "Wind Turbines",
  ...
  },
  {
    ...
    description:
      "State-of-the-art laboratory equipment used for materials testing and energy analysis.",
    image: {
      fields: {
        title: "Lab Equipment",
  ...
  },
  {
    ...
    description:
      "Presenting our latest findings at the International Energy Conference.",
    image: {
      fields: {
        title: "Conference",
  ...
  },
  {
    ...
    description:
      "Conducting field research to study renewable energy integration in rural communities.",
    image: {
      fields: {
        title: "Field Work",
  ...
  },
  {
    ...
    description:
      "Exploring innovative sustainable building designs incorporating renewable energy systems.",
    image: {
      fields: {
  ...
  },
  {
    ...
    description:
      "Testing and optimizing EV charging infrastructure for maximum efficiency and sustainability.",
    image: {
      fields: {
        title: "EV Charging",
  ...
  },
  {
    ...
    description:
      "Developing and testing smart grid solutions for efficient energy distribution.",
    image: {
      fields: {
        title: "Smart Grid",
